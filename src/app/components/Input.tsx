...
export function InputControl(props: InputControlProps) {
    return <input className="outline-none  flex-1 border-0 bg-transparent p-0 text-zinc-900 placeholder:zinc-600 dark:text-zinc-100 dark:placeholder-zinc-400" type="text"
        {...props}
    />
}

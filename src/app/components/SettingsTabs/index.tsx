    ...
    return (
        <Tabs.Root value={currentTab} onValueChange={setCurrentTab}>
            <ScrollArea.Root className="w-full" type="scroll">
                <ScrollArea.ScrollAreaViewport className="w-full overflow-x-scroll">
                ...
                <ScrollArea.ScrollAreaScrollbar className="flex h-0.5 translate-y-1.5 touch-none select-none flex-col bg-zinc-100" orientation="horizontal">
                    <ScrollArea.ScrollAreaThumb className="relative flex-1 rounded-lg bg-zinc-300" />
